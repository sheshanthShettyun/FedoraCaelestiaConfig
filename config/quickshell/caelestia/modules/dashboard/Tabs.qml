...
Item {
    ...
    TabBar {
        ...
        Repeater {
            ...
            delegate: Tab {
                ...
                iconScale: modelData.iconScale ?? 1
                text: modelData.text
            }
        }
    }
    ...
    component Tab: TabButton {
        ...
        contentItem: CustomMouseArea {
            ...
            implicitWidth: Math.max(tab.iconSource ? imageIcon.width : icon.width, label.width)
            ...
            MaterialIcon {
                ...
                fontStyle: Tokens.font.icon.builders.medium.scale(tab.iconScale).build()
            ...
            ColouredIcon {
                ...
                anchors.bottom: label.top
                visible: !!tab.iconSource
                implicitSize: Math.round(Tokens.font.icon.medium.pointSize * tab.iconScale)
                source: tab.iconSource
                colour: tab.current ? Colours.palette.m3primary : Colours.palette.m3onSurfaceVariant
            }
